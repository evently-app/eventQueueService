...
describe("addScoreToEvent", function() {
	...
	it("checking addDistanceScore function", function() {
		...
		var scoredEvents = sort.addDistanceScore(mockEvent,mockUserLocation.latitude,mockUserLocation.longitude);
		scoredEvents.sort(
	...
	it("checking addDescQualityScore function", function() {
		mockEvent = [
			...
			{
				id:"4",
				description:"This description has 20 words w w w w w w w w w w w w w w w",
			},
			{
				id:"5",
				description:"This description has 25 words w w w w w w w w w w w w w w w w w w w w",
			}
		];
	...
	it("checking addPreferenceScore function", function() {
		...
		var scoredEvents = sort.addPreferenceScore(mockEvent,mockUserPreference);
		scoredEvents.sort(
			function(event1,event2){
